...
const ShopTopActions = ({
  ...
  return (
    <div className="rv-shop-area__top-actions">
      <div className="row gy-3 align-items-center overflow-hidden">
        <DivAnimateXAxis
          position={-60}
          className="col-xxl-6 col-xl-6 col-lg-5 text-center text-md-start"
        >
          <p className="text-center text-lg-start mb-0">
            Showing {startIndex + 1}-{endIndex} OF {totalItems} results
          </p>
        </DivAnimateXAxis>
        <DivAnimateXAxis className="col-xxl-6 col-xl-6 col-lg-7">

  ...
  return (
    <div className="rv-shop-area rv-section-spacing">
      <div className="container">
        ...
        <div className="row gy-5 justify-content-center overflow-hidden">
          <DivAnimateXAxis
            position={-60}
            className="col-xl-3 col-lg-4 col-md-6 col-sm-8 col-9 col-xxs-12 order-1 order-lg-0"
          >
            <ShopSidebar
          ...
          <DivAnimateXAxis className="col-xl-9 col-lg-8 order-0 order-lg-1">
